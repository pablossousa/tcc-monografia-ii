...
A análise dos trabalhos relacionados permitiu identificar diferentes abordagens para o uso de biometria em contextos educacionais e de controle de acesso, bem como suas principais características e limitações. As comparações realizadas evidenciaram oportunidades para a aplicação de reconhecimento facial baseado em \textit{embeddings} como alternativa aos mecanismos tradicionais de identificação. Com base nessas referências e nos conceitos discutidos anteriormente, o próximo capítulo apresenta a metodologia adotada neste trabalho, abrangendo tanto a etapa de validação experimental da abordagem quanto o desenvolvimento do protótipo funcional de reconhecimento facial, incluindo sua arquitetura, componentes principais e procedimentos de avaliação.
